...
TEST_CASE("Modules::Task", "[modules]") {
    SECTION("can successfully instantiate") {
        REQUIRE_NOTHROW(Modules::Task(PXP_AGENT_BIN_PATH, TASK_CACHE_DIR, TASK_CACHE_TTL, MASTER_URIS, CA, CRT, KEY, CRL, "", 10, 20, STORAGE));
    }
}

TEST_CASE("Modules::Task::hasAction", "[modules]") {
    Modules::Task mod { PXP_AGENT_BIN_PATH, TASK_CACHE_DIR, TASK_CACHE_TTL, MASTER_URIS, CA, CRT, KEY, CRL, "", 10, 20, STORAGE };
...
TEST_CASE("Modules::Task::callAction", "[modules]") {
    ...
    Modules::Task e_m { PXP_AGENT_BIN_PATH, TEMP_TASK_CACHE_DIR, TASK_CACHE_TTL, MASTER_URIS, CA, CRT, KEY, CRL, "", 10, 20, STORAGE };
...
TEST_CASE("Modules::Task::callAction - non blocking", "[modules]") {
    configureTest();
    lth_util::scope_exit config_cleaner { resetTest };
    Modules::Task e_m { PXP_AGENT_BIN_PATH, TASK_CACHE_DIR, TASK_CACHE_TTL, MASTER_URIS, CA, CRT, KEY, CRL, "", 10, 20, STORAGE };
...
TEST_CASE("Modules::Task::executeAction", "[modules][output]") {
    ...
    SECTION("errors on download when no master-uri is provided") {
        Modules::Task e_m { PXP_AGENT_BIN_PATH, TEMP_TASK_CACHE_DIR, TASK_CACHE_TTL, {}, CA, CRT, KEY, CRL, "", 10, 20, STORAGE };
        auto task_txt = (DATA_FORMAT % "\"0632\""
                                     % "\"task\""
                                     % "\"run\""
                                     % "{\"task\": \"unparseable\", \"input\":{\"message\":\"hello\"}, "
...
TEST_CASE("purge old tasks", "[modules]") {
    ...
    Modules::Task e_m { PXP_AGENT_BIN_PATH, PURGE_TASK_CACHE, TASK_CACHE_TTL, MASTER_URIS, CA, CRT, KEY, CRL, "", 10, 20, STORAGE };
